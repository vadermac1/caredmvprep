...
export const metadata: Metadata = {
  ...
  description:
    "Free New Jersey motorcycle practice test based on the 2025 New Jersey Motorcycle Manual. Prepare for your NJ Motor Vehicle Commission motorcycle endorsement knowledge test.",
