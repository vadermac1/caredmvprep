...
export const metadata: Metadata = {
  ...
  description:
    "Free Minnesota motorcycle practice test based on the 2025 Minnesota Motorcycle Manual. 25 questions, 80% passing score. Prepare for your MN Driver and Vehicle Services motorcycle endorsement knowledge test.",
...
const data: PracticeTestPageProps = {
  ...
  about: [
    "The Minnesota Driver and Vehicle Services (DVS), a division of the Minnesota Department of Public Safety, requires all motorcycle operators to hold a motorcycle endorsement on their Minnesota driver's license. To earn the endorsement, applicants must pass a 25-question motorcycle knowledge test at a DVS exam station with at least 80% (20/25 correct). After passing, riders receive a motorcycle instruction permit and must either pass a road skills test at a DVS-approved site, or waive the skills test by completing an approved Minnesota Motorcycle Safety Program (MSP) course — an MSF-based program available at community colleges and training facilities throughout Minnesota.",
    "Minnesota has a universal motorcycle helmet law: ALL motorcycle riders and passengers must wear a DOT-approved protective helmet at all times. There are no exceptions based on age or riding experience. Eye protection is also required — a face shield, goggles, or a windshield that extends above eye level. Minnesota's motorcycle riding season is shorter than many states due to cold winters — the riding season typically runs from May through October, with early spring and late fall conditions that include cold temperatures, wet roads, and frost hazards.",
  ...
  sampleQuestions: [
    { question: "Minnesota's motorcycle helmet law requires helmets for:", options: ["Riders under 21 only", "Riders in their first 3 years of endorsement", "ALL riders and passengers — no exceptions in Minnesota", "Only riders on roads with speed limits over 35 mph"], correctIndex: 2, explanation: "Minnesota has a universal helmet law requiring ALL motorcycle operators and passengers to wear a DOT-approved protective helmet — no age or experience exceptions. Eye protection is also required. Minnesota DVS emphasizes that helmets reduce fatal head injury risk by approximately 37%. Minnesota's short riding season means many riders have seasonal gaps in their experience — the helmet requirement is especially important at the start of each riding season." },
  ...
  faqs: [
    { question: "How do I get a Minnesota motorcycle endorsement?", answer: "Pass the 25-question motorcycle knowledge test (80% = 20/25) at a MN DVS exam station to receive a motorcycle instruction permit. Then either pass the road skills test at a DVS-approved site, or complete an approved Minnesota Motorcycle Safety Program (MSP) course to waive the skills test. Submit your MSP certificate at a DVS office to receive the motorcycle endorsement." },
    { question: "Does Minnesota require helmets for all motorcycle riders?", answer: "Yes. Minnesota has a universal helmet law requiring ALL motorcycle operators and passengers to wear a DOT-approved helmet — no exceptions for age or experience. Eye protection (face shield, goggles, or windshield) is also required. Violations result in fines. Minnesota's DVS strongly recommends helmets as the single most effective motorcycle safety measure." },
