...
export const metadata: Metadata = {
  ...
  description:
    "Free Maryland motorcycle practice test based on the 2025 Maryland Motorcycle Manual. 25 questions, 80% passing score. Prepare for your MD Motor Vehicle Administration motorcycle endorsement knowledge test.",
...
const data: PracticeTestPageProps = {
  ...
  intro:
    "Prepare for your Maryland motorcycle endorsement knowledge test with free practice questions based on the official Maryland Motorcycle Manual. The Maryland Motor Vehicle Administration (MVA) requires all motorcycle riders to hold a motorcycle endorsement on their driver's license. Pass the MVA knowledge test, then complete the road skills test — or waive the skills test by completing an approved Maryland Motorcycle Safety Program (MMSP) course.",
  basedOn: "2025 Maryland Motorcycle Manual",
  about: [
    "The Maryland Motor Vehicle Administration (MVA) requires all motorcycle operators to hold a motorcycle endorsement on their standard Maryland driver's license. To earn the endorsement, applicants must pass a 25-question motorcycle knowledge test at an MVA full-service office with at least 80% (20/25 correct). After passing, applicants receive a motorcycle permit and must pass an MVA road skills test — or waive the skills test by completing the Maryland Motorcycle Safety Program (MMSP), an approved MSF-based training program available at community colleges and training facilities throughout Maryland.",
  ...
  sampleQuestions: [
    ...
    { question: "The Maryland Motorcycle Safety Program (MMSP) provides what benefit for endorsement applicants?", options: ["It waives the MVA knowledge test — graduates skip directly to the road skills test", "It waives the road skills test — graduates still need to pass the knowledge test", "It waives both the knowledge test and road skills test", "It provides a provisional motorcycle permit for 6 months with no other tests required"], correctIndex: 1, explanation: "Completing the Maryland Motorcycle Safety Program (MMSP) — an MSF-based training course — waives the MVA road skills test for the motorcycle endorsement. You still need to pass the 25-question knowledge test (20/25 = 80%) at an MVA full-service office. MMSP courses are offered at community colleges throughout Maryland. Present your MMSP completion certificate at the MVA to receive the motorcycle endorsement without a separate skills test." },
  ...
  faqs: [
    { question: "How do I get a Maryland motorcycle endorsement?", answer: "Pass the 25-question motorcycle knowledge test (80% = 20/25) at an MD MVA full-service office to receive a motorcycle permit. Then either pass the road skills test at an MVA location, or complete the Maryland Motorcycle Safety Program (MMSP) to waive the skills test. Present your MMSP certificate at the MVA to receive the motorcycle endorsement." },
    ...
    { question: "What is the MMSP motorcycle safety course in Maryland?", answer: "The Maryland Motorcycle Safety Program (MMSP) is an MSF-based training course administered through the Maryland Highway Safety Office. It includes both classroom instruction and hands-on riding exercises. Upon completion, the road skills test at the MVA is waived. MMSP courses are available at community colleges and approved training sites throughout Maryland." },
    {
