...
export const metadata: Metadata = {
  ...
  description:
    "Free Louisiana driver's license practice test based on the LA OMV Driver's Guide. 40 questions, 80% passing. Louisiana's open container laws, hurricane evacuation contraflow rules, and OMV agency terminology. Pass your Louisiana knowledge test first try.",
...
const data: PracticeTestPageProps = {
  ...
  intro:
    "Louisiana driver licensing is administered by the Office of Motor Vehicles (OMV), part of the Louisiana Department of Public Safety and Corrections (DPSC). The 40-question knowledge test requires 32 correct (80%) to pass. Louisiana has two uniquely tested laws: open container rules (Louisiana allows passenger open containers under specific circumstances that drivers must understand) and hurricane evacuation contraflow — a system used only in Louisiana for major evacuations.",
  ...
  keyRules: [
    ...
    { icon: "🚗", rule: "Learner's permit at 15 (180-day hold)", detail: "Learner's permit issued at 15; must hold 180 days minimum before a Restricted License. Supervised by adult 18 or older — not 21+ as in many other states." },
    { icon: "🌙", rule: "Restricted License: 11PM–5AM curfew", detail: "Under 17: no driving 11PM–5AM without a licensed adult 21+ present; maximum 1 non-family passenger under 21 during the first 6 months of Restricted License." },
  ...
  sampleQuestions: [
    ...
    },
    {
      ...
      options: [
        ...
        "Age 15 — permit holders must be supervised by a licensed adult 18 or older at all times while driving",
      ...
      correctIndex: 1,
      explanation:
        "Louisiana issues learner's permits at age 15 (La. R.S. 32:409.1). The permit requires supervision by a licensed adult driver who is at least 18 years old and seated in the front passenger seat whenever the permit holder is driving. Louisiana's 180-day minimum hold applies before the permit holder can apply for a Restricted License. Louisiana does not set a minimum age of 21 for supervisors (unlike some states that require 21+) — any licensed adult 18 or older can supervise a Louisiana learner. Supervisors may include older siblings or other adult family members, not just parents.",
    },
    {
      question: "Louisiana's Restricted License (for drivers 16–17) includes which of the following restrictions?",
      options: [
        ...
        "No driving between 11PM and 5AM without a licensed adult 21+ in the vehicle; max 1 non-family passenger under 21 during first 6 months",
        "No driving on interstates during the first 6 months; all other driving is unrestricted",
      ],
      correctIndex: 2,
      explanation:
        "Louisiana's Restricted License (issued between ages 16 and 17 after holding a learner permit for 180 days) carries two main restrictions: (1) Curfew: no driving between 11PM and 5AM unless a licensed adult 21+ is present in the vehicle, or unless traveling to/from work, school, or an emergency; (2) Passenger restriction: for the first 6 months of holding the Restricted License, no more than one non-family passenger under 21 is permitted in the vehicle. Immediate family members are excluded from the passenger count. Both restrictions are lifted when the driver turns 17 and has met all other requirements, or transitions to a full Class E license at 17 with driver education or 18 without.",
    },
    {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Louisiana's GDL differs from many states in two notable ways: (1) the supervisor age is 18, not 21 — older siblings or young adults can supervise a learner permit holder, which is unusual; (2) adult applicants (17+) may obtain a license with only a knowledge test, no road skills test — the road test is not mandated for adults. Louisiana's Restricted License (16–17) stage includes a curfew (11PM–5AM) and passenger restriction (1 non-family passenger under 21 for first 6 months). Louisiana's learner permit age (15) matches the majority of states.",
    },
    {
