...
export const metadata: Metadata = {
  ...
  description:
    "Free Colorado motorcycle practice test based on the 2025 Colorado Motorcycle Operator Manual. 25 questions, 80% passing score. Prepare for your CO Division of Motor Vehicles motorcycle endorsement test.",
...
const data: PracticeTestPageProps = {
  ...
  intro:
    "Prepare for your Colorado motorcycle endorsement knowledge test with free practice questions based on the official Colorado Motorcycle Operator Manual. The Colorado Division of Motor Vehicles (DMV) requires all motorcycle riders to hold a motorcycle endorsement on their driver's license. Pass the DMV knowledge test and road skills test — or waive the skills test by completing an approved Colorado Motorcycle Operator Safety Training (MOST) program.",
  basedOn: "2025 Colorado Motorcycle Operator Manual",
  about: [
    "The Colorado Division of Motor Vehicles (DMV) requires all motorcycle operators to hold a motorcycle endorsement on their standard driver's license. To earn the endorsement, applicants must pass a 25-question motorcycle knowledge test at a Colorado DMV office with at least 80% (20/25 correct). After passing, riders receive a motorcycle instruction permit and must complete a road skills test at a Colorado DMV site — or waive the skills test by completing an approved Colorado Motorcycle Operator Safety Training (MOST) program. MOST courses are offered through community colleges and approved training facilities throughout Colorado.",
  ...
  faqs: [
    { question: "How do I get a Colorado motorcycle endorsement?", answer: "Pass the 25-question motorcycle knowledge test (80% = 20/25) at a CO DMV office to receive a motorcycle instruction permit. Then either pass the road skills test at a DMV location, or complete an approved Colorado Motorcycle Operator Safety Training (MOST) program to waive the skills test. Submit your MOST certificate at the DMV for the motorcycle endorsement." },
