...
export const metadata: Metadata = {
  ...
  description:
    "Free South Carolina SCDMV practice test based on the SC Driver's Manual. 30 questions, 80% passing. Emma's Law IID requirement, golf cart road laws, and SC-specific graduated licensing. Pass your South Carolina knowledge test first try.",
