...
const data: PracticeTestPageProps = {
  ...
  about: [
    "Oregon's motorcycle endorsement is issued by Oregon DMV (part of ODOT) after passing the knowledge test and skills test, OR completing an approved MSF BRC (which waives the skills test). Oregon has a universal helmet law (ORS 814.280): all motorcycle operators and passengers must wear an Oregon-approved motorcycle helmet (which meets DOT standards). Oregon's Basic Speed Rule (ORS 811.100) — which allows citation for driving too fast for conditions even below the posted limit — applies equally to motorcycle operators. On Oregon's winding mountain roads, coastal fog routes, and rain-slickened pavement, the Basic Speed Rule has real practical consequences for riders who travel at posted limits in hazardous conditions.",
  ...
  faqs: [
    ...
    {
      question: "Can Oregon motorcycle riders use the MOST or MSF course to waive the road skills test?",
      answer:
        "Oregon DMV accepts completion of an MSF Basic RiderCourse (BRC) or an approved equivalent course as a waiver for the motorcycle road skills test. After completing the BRC, the completion card is presented to Oregon DMV in lieu of the skills test. The knowledge test is still required at the DMV office. Oregon has an active MSF training network through community colleges and private training sites, typically operating from March through October.",
    },
    {
