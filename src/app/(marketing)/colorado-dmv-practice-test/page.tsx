...
export const metadata: Metadata = {
  ...
  description:
    "Free Colorado DMV practice test based on the 2025 Colorado Driver Handbook. 25 questions, 80% to pass. Covers DWAI criminal charge at 0.05%–0.079% BAC, 5 ng/mL cannabis DUI, I-70 mountain corridor chain law, traction law, and hands-free ban (effective Jan 2025).",
